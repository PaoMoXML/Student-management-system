...
<link rel="stylesheet" type="text/css" href="../css/bootstrap.min.css" />
  ...
  <div class="col-sm-3 col-md-2 sidebar" >
          <ul class="nav nav-sidebar">
            ...
            <li><a href="${pageContext.request.contextPath}/jsp/managerTeacher.jsp" target="right">教师查询</a></li>
          </ul>
          <ul class="nav nav-sidebar">
          ...
          <div class = "container" style="margin:35px auto auto auto;">
            <iframe src="${pageContext.request.contextPath}/jsp/teacher.jsp" name="right" width="1000" height="700" frameborder="0" ></iframe>
          </div>
